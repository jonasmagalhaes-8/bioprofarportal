...
export class VerTudoArtigos extends React.Component<{
  artigos: ArtigoModel[];
  onClose: () => void;
  onItemClick: (artigo: ArtigoModel) => void;
}> {
  state = {
    termoPesquisa: '',
      ...
      <div style={overlayStyle}>
        <div style={responsiveModalStyle} onClick={(e) => e.stopPropagation()}>
          <div style={headerStyle}>
            <h2 style={titleStyle}>Todos os Artigos</h2>
            ...
            <div style={gridStyle}>
              {artigosFiltrados.map((artigo) => (
                ...
                >
                  ...
                  <p style={{ fontSize: '13px', color: '#7a8a6a', marginBottom: '8px' }}>
